...
class _WelcomeOnboardingDialogState extends State<WelcomeOnboardingDialog> {
  ...
  Future<void> _generateInviteLink() async {
    ...
    try {
      ...
      final keyPackageEvent = await Groups.sharedInstance.createPermanentKeyPackage(relays);
      ...
      _inviteLink = '${AppConfig.inviteBaseUrl}?keypackage=$keyPackageParam&pubkey=${Uri.encodeComponent(senderPubkey)}&relay=${Uri.encodeComponent(relayUrl)}';
      ...
      if (compressedKeyPackage != null) {
        ...
        debugPrint('Keypackage compressed: ${(ratio * 100).toStringAsFixed(1)}% of original size');
      }
