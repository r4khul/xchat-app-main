...
class CircleApi {
  ...
  /// 
  /// [baseUrl] Optional base URL for the API (defaults to http://127.0.0.1:3000)
  /// 
      ...
      final result = await CircleRequest.post<List<RelayAddressInfo>>(
        ...
        parseSuccess: (json) {
          ...
          final relays = relaysList
              ...
              .toList();
          LogUtil.d(() => 'Successfully fetched ${relays.length} relay addresses');
          return relays;
        },
      );
      return result;
    } catch (e) {
      LogUtil.e(() => 'Error in getRelayAddresses: $e');
      rethrow;
    }
  }
    ...
    try {
      ...
      final result = await CircleRequest.post<PaymentVerificationResult>(
        ...
        parseSuccess: (json) {
          ...
          LogUtil.d(() => 'Payment verified successfully. Tenant ID: ${result.tenantId}, Relay URL: ${result.relayUrl}');
          return result;
        },
      );
      return result;
    } catch (e) {
      LogUtil.e(() => 'Error in verifyPayment: $e');
      rethrow;
    }
  }
